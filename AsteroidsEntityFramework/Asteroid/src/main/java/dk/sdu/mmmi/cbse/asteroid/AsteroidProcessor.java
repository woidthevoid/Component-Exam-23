...
import dk.sdu.mmmi.cbse.commonasteroid.ISplitter;

public class AsteroidProcessor implements IEntityProcessingService {
    private ISplitter asteroidSplitter = new AsteroidSplitter();
    ...
    public void process(GameData gameData, World world) {
        ...
        for (Entity asteroid : world.getEntities(Asteroid.class)) {
            ...
            movingPart.setAcceleration(speed);
    ...
    public void setAsteroidSplitter(ISplitter asteroidSplitter) {
        this.asteroidSplitter = asteroidSplitter;
    }

    public void removeAsteroidSplitter(ISplitter asteroidSplitter) {
